...
import TypeSystemsInLean.STLCRecords.Syntax
...
| .consRec l t r =>
    ...
    ラベル `l` は束縛変数ではないため変更せず、
    フィールドの項と残りのレコードだけを再帰的にリネームする。
    -/
    .consRec l (rename ρ t) (rename ρ r)
